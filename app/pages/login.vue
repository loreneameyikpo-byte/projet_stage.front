          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full rounded-lg border border-slate-300 pl-10 pr-10 py-2.5 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary"
              />
              <button
                type="button"
                @click="afficherMotDePasse = !afficherMotDePasse"
                class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-secondary transition-colors"
                :aria-label="afficherMotDePasse ? 'Masquer le mot de passe' : 'Afficher le mot de passe'"
                tabindex="-1"
              >
                <svg v-if="afficherMotDePasse" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
