...
<template>
  <div>
    ...
    <!-- Aucun projet -->
    <div v-if="!projet" class="bg-card border border-slate-200 rounded-lg p-10 text-center">
    ...
    <template v-else>
      <div class="grid lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-card border border-slate-200 rounded-lg p-6">
          ...
          <NuxtLink
            to="/etudiant/projet"
            class="inline-flex items-center gap-2 bg-secondary hover:bg-primary text-white text-sm font-medium px-4 py-2 rounded-lg transition"
          >
      ...
      <div class="bg-card border border-slate-200 rounded-lg p-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <NuxtLink
            ...
            class="inline-flex items-center gap-2 bg-secondary hover:bg-primary text-white text-sm font-medium px-4 py-2 rounded-lg transition shrink-0"
          >
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
